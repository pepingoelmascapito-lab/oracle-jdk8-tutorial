...
public class Persona extends Object {
	 ...
	 * en este formatoes es que existe una huerramienta que se le llama Javadoc, que
	 ...
	 * 
	 * Es un identificador, es decir un nombre que hace referencia a una ubicacion,
	 * direccion, en la memoria RAM del equipo y en la cual se puede almacenar un
	 * valor de un tipo de dato concreto.
	 * 
	 ...
	 */
	/*
	 * la variable nombre, declara a continuacion, solamente va a permitir que se
	 * alamacene en ella cadenas de caracteres, es decir, letras de la A a la Z
	 * mayusculas y minusculas, porque antes del nombre de la variable (nombre)
	 * hemos puesto el tipo de dato string que indica que la variable solamente
	 * puede almacenar valores encerrados enttre comillas dobles
	 */
